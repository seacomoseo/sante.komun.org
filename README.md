...
- If new project (not fork):
  - Copy [sante.komun.org project files](https://github.com/leandaovida/sante.komun.org)
...
- `README.md` ⏩ edit baseURL ("sante.komun.org") + delete steps bit by bit
- Design
...
- If Netlify
  - [`Domain Management / settings`](https://app.netlify.com/sites/leandaovida/settings/domain)
  - `Add custom domain`
  - `Check DNS configuration` Copy
  - Add `DNS Records` copied from Netlify to Domain gestor:
    - From: `sante.komun.org`
...
- If Cloudflare Pages
  - [Custom domains](https://dash.cloudflare.com/?to=/:account/pages/view/leandaovida/domains)
  - `Set up a custom domains`
  - `sante.komun.org`
  - `Continue`
  - `Activate domain` (if `Begin DNS transfer` end)
  - Repeat with `www.sante.komun.org`
  - ...........................................................
...
1. [Servicios sante.komun.org](https://drive.google.com/file/d/1trq28fMfEVwoZOk4ue0tJzAJDZtj64BK) ⏩ `File ⏩ Make a copy` ⏩ Select client directory.
1. Change the info.
